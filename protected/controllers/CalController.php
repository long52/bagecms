 ...
 * @version       v3.1.0
 */
class CalController extends XFrontBase
{
  /**
   * 首页
   */
  ...
  public function actionShow( $id ) {
    $bagecmsShow = Calendar::model()->findByPk( intval( $id ) );
...
//    }
  ...
  public function actionCalComment() {
    ...
    try {
      ...
      $bagecmsPostCommentModel = new CalComment();
