...
<link rel="stylesheet" type="text/css" href="<?php echo $this->_baseUrl?>/static/calendar/css/manage.css">
<script type="text/javascript" src="<?php echo $this->_baseUrl?>/static/js/jquery/jquery-1.7.1.min.js"></script>
</head>

<body scroll="no">
<div class="header">
  <div class="logo">xunlong.me</div>
  <div class="nav">
    <ul>
  ...
  <div class="logininfo"><span class="welcome"><img src="<?php echo $this->_baseUrl?>/static/calendar/images/user_edit.png" align="absmiddle"> 欢迎, <em><?php echo $this->_xsession['_adminiUserName']?></em> </span> <a href="<?php echo $this->createUrl('admin/ownerUpdate')?>" target="win">修改密码</a> <a href="<?php echo $this->createUrl('public/logout')?>" target="_top">退出登录</a> <a href="<?php echo Yii::app()->homeUrl?>" target="_blank">前台首页</a></div>
</div>
<div class="topline">
