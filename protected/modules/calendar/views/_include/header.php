...
<link rel="stylesheet" type="text/css" href='<?php echo $this->_baseUrl?>/static/calendar/css/common.css'>
...
<script src="<?php echo $this->_baseUrl?>/static/calendar/js/base.js" ></script>
