...
<table class="form_table">
  ...
  <tr >
    <td class="tb_title">适用范围：<?php echo $form->dropDownList($model,'scope',XParams::$attrScope,array('onchange'=>'changeScope(this)')); ?><span id="catalogSpan" <?php if($model->scope != 'post'):?>style="display:none"<?php endif?>> 类别归属：
