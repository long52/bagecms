  ...
  <table class="content_list">
    ...
    <tbody>
      ...
      <tr bgcolor="<?=$info['bgcolor']?>">
        ...
        <td><a href="<?php echo $this->createUrl('database/import',array('pre'=>$info['pre'], 'dosubmit'=>'1'))?>"><img src="<?php echo $this->_baseUrl?>/static/calendar/images/refresh.png" align="absmiddle" /></a>&nbsp;&nbsp;&nbsp; <a href="<?php echo $this->createUrl('database/operate',array('command'=>'downloadFile','sqlfile'=>$info['filename']))?>"><img src="<?php echo $this->_baseUrl?>/static/calendar/images/download.png" align="absmiddle" /></a></td>
      </tr>
      <?php endforeach?>
      <?php endif?>
    </tbody>
